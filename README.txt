...
Rename the progassessment folder into a lower case name of your module. Make sure
...
instances of string "progassessment" to your new module name (eg "widget").
   
Rename the file lang/en_utf8/progassessment.php to widget.php or whatever your
module name is.
...
should find that this progassessment has been added to the list of recognized
modules.  
...
Credits for work on this progassessment template
-------------------------------------------
